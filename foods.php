...
<html>
    ...
    <body>
        ...
        <br>
        <div class="container">
            <div style="border-radius:50px;" id="food_body" class="row">
                <div class="row">
                    <div align="center">
                ...
                ?>
                    ...
                    <div align="center" id="image_body" class="col-md-3">
                        <a href="details_food.php? username=<?php echo $loggedUsername?> & food_id=<?php echo $food_id ?>" style="text-decoration:none;">
                            <img id="food_image" class="img-responsive" src="images/<?php echo $food_id ?>.jpg">
                            <h3 id="food_name"><?php echo $row['f_name'] ?></h3>
                            <h4 id="food_address">Price : BDT <?php echo $row['price'] ?></h4>
                        </a>
                    </div>
