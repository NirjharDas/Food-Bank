...
$rest_idx           = $_GET['restaurant_id'];

/* Data of Previous Page */


/* To Get User's User ID */
...
/* To Get Proper Info Of The Current Restaurant */

$query1     = "SELECT * FROM `restaurent` WHERE rest_ID = '$rest_idx'";
...
/* To Get Proper Info Of The Cureent Restaurant */


/* To Get Which User Did Which Comment */

$query2     = "SELECT * FROM `review` NATURAL JOIN `customers` WHERE rest_ID = '$rest_idx'";
...
else
{
    if(isset($_SESSION['comment_box']))
    {
        ...
        $query3  = "INSERT INTO review (C_ID,restaurant,rest_ID,review) 
        
                    VALUES ('$user_id',1,'$rest_id','$comment')";
...
else
{
    if(isset($_SESSION['rate_box']))
    {
        ...
        $query4  = "REPLACE INTO restaurent_rating (C_ID,rest_ID,rating) 
        
                    VALUES ('$user_id','$rest_id','$rate')";
...
/* To See User's Current Rate */

$query5         = "SELECT * FROM restaurent_rating WHERE C_ID='$user_id'";
...
/* To See The Restaurant's Overall Rating */

$query6         = "SELECT ROUND(AVG(restaurent_rating.rating),2) As average
                   FROM restaurent_rating 
                   WHERE restaurent_rating.rest_ID='$rest_id' 
                   GROUP BY restaurent_rating.rest_ID";
...
<html>
    ...
    <head>
        ...
        <style>
            ...
            #restaurant_detail_rating_main_button
            {
                float: right;
                width: 80%;
                height: 5%;
            ...
            <div style="margin-left:0%;border-radius:50px;" id="restaurant_details" class="row">
                <div class="row">
                    <div align="center" class="container">
                        <h1 id="restaurant_detail_title"><?php echo $rest_name ?></h1>
                        <h3 id="restaurant_detail_address"><?php echo $rest_address ?></h3>
                        <?php
                        if($zero_average == 0)
                        {
                        ?>
                            <h4 id="restaurant_detail_rating">Rating : <?php echo $average_rating ?> / 5</h4>
                        <?php 
                        }
                        else
                        {
                        ?>
                            <h4 id="restaurant_detail_rating">Rating : None</h4>
                        <?php 
                        } 
                        ?>
                        <a id="restaurant_detail_review" href="#restaurant_detail_review_main">Reviews</a>
                    </div>
                    <br><br>
                    <div class="row"> 
                        <div class="col-md-2"></div>
                        <div class="col-md-8">
                            <img id="image" class="img-responsive" src="images/<?php echo $rest_id ?>.jpg">
                        </div>
                        <div class="col-md-2"></div>
                    </div>
                    <div align="center">
                                ...
                                <div id="child2">
                                    ...
                                    <div style="margin-top:-2%;" id="parent">
                                        <form action="" method="post">
                                            <div id="child3">
                                                <input type="number" min="1" max="5" placeholder="Rate From 1 To 5"id="restaurant_detail_rating_main" name="rate_box" >
                                            </div>
                                            <div id="child4">
                                                <button id="restaurant_detail_rating_main_button" name="rate_button"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                                            </div>
                                            <div>
                                                <?php
                                                if($zero_current == 0)
                        ...
                        <div class="col-md-8">
                            ...
                            <div>
                                <div align="center" class="row">
                                    ...
                                    <form action="details_restaurant.php? username=<?php echo $loggedUsername ?> & restaurant_id=<?php echo $rest_idx ?>" method="post">
                                        <br>
